...
struct Dev_Lamp : Service::LightBulb {       // Dimmable LED
  ...
  Dev_Lamp(int pin, int powerPin, int raisePin, int lowerPin) : Service::LightBulb(){
    ...
    new SpanButton(powerPin);                       // NEW! create new SpanButton to control power using pushbutton on pin number "powerPin"
                  // NEW! create new SpanButton to decrease brightness using pushbutton on pin number "lowerPin"
